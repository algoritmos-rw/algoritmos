...
* Sergio: es un fanático del rugby. Ya ha declarado que "ama más a Moshi (la estrella del equipo) que
...
Para resolver esto en tiempo lineal, vamos a implementar el algoritmo de Hierholzer, que [explicamos aquí](/algoritmos/material/apuntes/camino_euler). En caso que no exista un ciclo Euleriano, no se puede cumplir con lo pedido en la consigna (ver más abajo el error que debe mostrarse en ese caso). 
...
Las pruebas del curso considerarán el mapa de este presente mundial de Rugby, el mapa [del último mundial de esquí (Qatar 2022)](/algoritmos/tps/2022_2/tp3), el mapa [del último mundial de tejo de playa (Rusia 2018)](/algoritmos/tps/2018_1/tp3), así como un mapa generado al azar para un escenario de volumen.
...
Contamos con un [apunte sobre cómo crear, usar y visualizar archivos KML](/algoritmos/material/apuntes/kml).
