...
Diseñar esta nueva primitiva de manera tal que se comporte en orden $$\mathcal{O}(\log n)$$ si tuviésemos un índice con el cual podamos encontrar la ubicación del elemento cuya prioridad debe ser actualizada en orden sublineal.
