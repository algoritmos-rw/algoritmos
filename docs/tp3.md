...
![Wachenchauzer Studios]({{ site.baseurl }}{% link assets/wachen_studios_box.jpeg %} "Wachenchauzer Studios")
...
![Power Law Marvel]({{ site.baseurl }}{% link assets/degree-distribution.png %} "Power Law Marvel")
