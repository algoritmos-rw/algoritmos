...
layout: page
title: TP0
permalink: /tps/tda/tp0
---

TP0
=======

El adjunto [tp0.zip](http://www.algoritmos7541-rw.tk/tps/tp0/tp0.zip?attredirects=0&d=1) 
...
Además, deben subir el código a la [página de entregas de la materia](https://algoritmos2rw.appspot.com/), con el código completo.
